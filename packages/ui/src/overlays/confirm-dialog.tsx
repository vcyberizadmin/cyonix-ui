        ...
        {reason && (
          <label className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              className="bg-field border-field-border text-fg placeholder:text-fg-2 hover:not-focus:border-field-border-hover focus:border-focus duration-instant ease-brand rounded-sm border px-3 py-2 text-[13px] transition-colors focus:outline-none"
            />
          </label>
        )}
        ...
        {confirmPhrase && (
          <label className="flex flex-col gap-1.5">
            ...
            <input
              ...
              autoComplete="off"
              spellCheck={false}
              className="bg-field border-field-border text-fg hover:not-focus:border-field-border-hover focus:border-focus duration-instant ease-brand rounded-sm border px-3 py-2 font-mono text-[13px] transition-colors focus:outline-none"
            />
          </label>
        )}
      </div>
