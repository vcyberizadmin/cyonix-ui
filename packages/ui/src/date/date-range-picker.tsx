  ...
  return (
    ...
    >
      <button
        type="button"
        className={cn(
          "border-field-border bg-field hover:not-focus:border-field-border-hover focus:border-focus duration-instant ease-brand flex h-8 cursor-pointer items-center gap-1.5 rounded-sm border px-2.5 text-[12.5px] transition-colors focus:outline-none",
