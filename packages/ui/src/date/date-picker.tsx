      ...
      >
        <button
          ...
          className={cn(
            ...
            "bg-field border-field-border text-fg enabled:hover:not-focus:not-aria-invalid:border-field-border-hover focus:border-focus aria-invalid:border-danger duration-instant ease-brand flex h-9 w-full cursor-pointer items-center gap-2 rounded-sm border px-2.5 text-left text-[13px] transition-colors focus:outline-none disabled:cursor-not-allowed disabled:opacity-50",
            !value && "text-fg-2",
