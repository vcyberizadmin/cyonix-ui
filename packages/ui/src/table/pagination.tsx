        ...
        {onPageSizeChange && (
          <label className="text-fg-muted flex items-center gap-1.5 text-[11px]">
            ...
            <select
              ...
              className="border-field-border bg-field text-fg-2 hover:not-focus:border-field-border-hover focus:border-focus cursor-pointer rounded-sm border px-1.5 py-0.5 text-[12px] focus:outline-none"
            >
